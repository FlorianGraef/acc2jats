...
public class NestedKwd {
    ...
    protected List<NestedKwd> nestedKwds;
    ...
    /**
     * Gets the value of the nestedKwds property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nestedKwds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNestedKwds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NestedKwd> getNestedKwds() {
        if (nestedKwds == null) {
            nestedKwds = new ArrayList<NestedKwd>();
        }
        return this.nestedKwds;
    }

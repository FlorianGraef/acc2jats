...
/**
 * <p>Java class for typeLibraryStrategy.
 * 
...
public enum TypeLibraryStrategy {
    ...
    /**
     *  Random sequencing of whole transcriptome, also known as Whole Transcriptome Shotgun Sequencing, or WTSS). (see
     ...
     *             polarity of the transcript can be retained, which is important for correct annotation of novel genes, and identifying genomic
     *             regions that give rise to transcripts from both strands, and for resolving expression levels of overlapping genes
     *           
     * 
     */
    ...
    /**
     *  Micro RNA sequencing strategy designed to capture post-transcriptional RNA elements and include non-coding
    ...
    /**
     *  Sequencing of overlapping or distinct PCR or RT-PCR products. For example, metagenomic community profiling
     *             using SSU rRNA . 
     * 
     */
    AMPLICON("AMPLICON"),
    ...
    /**
     * Quantitatively determine fitness of bacterial genes based on how many times a purposely seeded transposon gets
    ...
    /**
     * enrichment of a targeted subset of loci. used for cancer gene panels, genetic testing panels, etc. replaces
     *             VALIDATION
     * 
     */

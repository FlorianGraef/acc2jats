 ...
 *       &lt;group ref="{}chem-struct-wrap-model"/>
...
@XmlType(name = "", propOrder = {
    ...
    "alternativesAndChemStructsAndCodes",
...
public class ChemStructWrap {
    ...
    protected List<Object> alternativesAndChemStructsAndCodes;
    @XmlElements({
    ...
    /**
     * Gets the value of the alternativesAndChemStructsAndCodes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the alternativesAndChemStructsAndCodes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAlternativesAndChemStructsAndCodes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAlternativesAndChemStructsAndCodes() {
        if (alternativesAndChemStructsAndCodes == null) {
            alternativesAndChemStructsAndCodes = new ArrayList<Object>();
        }
        return this.alternativesAndChemStructsAndCodes;
    }
